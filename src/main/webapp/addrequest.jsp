...
<input type="number" name="requestId" id="requestId" placeholder="Enter requestId"  required />
<br/>
<label>Request Amount:</label>
<input type="number" name="requestAmount" id="requestAmount" placeholder="Enter request"  required />
<br/>
...
function loadBooks()
{
    ...
    var formData = "requestType=" + requestType + "&requestId=" + requestId+ "&requestAmount="+requestAmount;
